      ...
      <div className={styles.container}>
        <div className={styles.topSection}>
          ...
          <div className={styles.brand}>
            <img src="/logo.png" alt="Girls Who Yap" className={styles.logo} />
            ...
            <div className={styles.socialIcons}>
              ...
              <a href="https://www.linkedin.com/company/doradao/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.bottomSection}>
          <p className={styles.copyright}>© 2025 GirlsWhoYap. All rights reserved.</p>
